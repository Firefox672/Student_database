document.addEventListener("DOMContentLoaded", function () {
  ...
  function redirectToCertificatesMessage() {
    window.open('certificate.pdf', '_blank');
  }

  certificatesBtn.addEventListener('click', redirectToCertificatesMessage);


  function redirectToFeeInfrastructureMessage() {
    window.open('fee92.pdf', '_blank');
  }
  ...
  function showFAQContent() {
    ...
    faqContent.innerHTML = `
      ...
      <ul>
        ...
        <li><span>Q1 : </span> I forgot my password. How can I reset it?
        <br>A : Please go to your class teacher and report about this issue.</li>
        
        <li><span>Q1 : </span> What information can I find in the student portal?<br>A : You can access your attendance, grades, your qualifications and others.</li>
        
        <li><span>Q1 : </span> Can I access my grades and academic records through the portal?<br>A : Yes, you can access your records, if there any problem with that please contact your class teacher.</li>
        
        <li><span>Q1 : </span> Is there a feature to track my academic progress and graduation requirements on the portal?<br>A : Yes, you can track your all records as submitted by your class teacher.</li>
